...
print("a의 아스키코드는? : ",ord('a'))
print("A의 아스키코드는? : ",ord('A'))
print("97의 문자는? : ",chr(97))
print("65의 문자는? : ",chr(65))
...
## 예제 03
# 알파벳 대문자와 숫자(0~9)로만 구성된 문자열을 알파벳은 오름차순으로 정렬하고 그뒤에 숫자는 더한값이 이어서 출력하도록 하시오.
# 입력예시 : K1KA5CB7
# 출력예시 : ABCKK13
...
# 문자열이 입력되었을때 문자를 하나씩 확인함
# 알파벳의 경우 별도의 리스트에 저장, 숫자인 경우 합계를 계산
